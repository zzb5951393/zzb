...
import { createInitialState, queueDirection, resetGame, stepGame, toggleRunning } from './game/state.js';
...
const renderer = new Renderer(canvas, './public/assets/snake-sprites.svg');
